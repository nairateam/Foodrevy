...
export const AuthPanel = () => {
  ...
  const { firstName, lastName, email, password, confirmPassword, isChecked, updateState } = useAuthContext();
        ...
        <form action="" className=''>
            ...
            onChange={(e) => handleInputChange('confirmPassword', e.target.value)}
             ...
             <span className='flex gap-2 text-[#FA5F05] py-4 mt-[-5px]'>
                <input type="checkbox" checked={isChecked} onChange={(e) => handleInputChange('isChecked', e.target.checked)} />
                I agree to the FoodRevy TERMS OF SERVICE and PRIVACY POLICY
            </span>
             <Button click={handleSignup} btn="Sign Up" btnBG='[#000]' btnColor='white' />
        </form>
